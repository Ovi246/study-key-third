...
function Form() {
  ...
  const retryZipCodeValidation = async (zipCode, state, city, retries = 3) => {
              ...
              <div className="space-y-8 w-full">
                <div>
                  ...
                  <p className="text-xl text-gray-600 mb-8">
                    Thank you for choosing our educational products! Share your
                    experience and select an exclusive reward.
                  </p>
                </div>
              ...
              <div className="space-y-8 w-full">
                ...
                <form className="space-y-6 w-full">
                  <div>
                    ...
                    />
                    {errors.fullName && (
                      <p className="mt-2 text-yellow-400">{errors.fullName}</p>
                    )}
                  </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6 w-full">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        />
                        {errors.city && (
                          <p className="mt-2 text-yellow-400">{errors.city}</p>
                        )}
                      </div>
                      ...
                      <div>
                        ...
                        />
                        {errors.state && (
                          <p className="mt-2 text-yellow-400">{errors.state}</p>
                        )}
                      </div>
                      ...
                      <div className="mb-4">
                        ...
                        <div className="relative">
                          <input
                            ...
                            maxLength="5"
                            disabled={
                              !formData.city || !formData.state.name || loading
                            }
                          />
                          {loading && (
                            <div className="absolute right-3 top-1/2 transform -translate-y-1/2">
